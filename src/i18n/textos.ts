...
const ES = {
  ...
  'hud.guardarAhora.ayuda': 'Escribe el lienzo en disco y guarda además una sesión con nombre',
...
const EN: Record<Clave, string> = {
  ...
  'hud.guardarAhora.ayuda': 'Writes the canvas to disk and also saves a named session',
